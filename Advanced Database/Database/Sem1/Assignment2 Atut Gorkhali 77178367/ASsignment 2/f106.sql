...
prompt  APPLICATION 106 - TRANSPORTATION REPORTING
--
-- Application Export:
--   Application:     106
--   Name:            TRANSPORTATION REPORTING
--   Date and Time:   01:24 Wednesday November 16, 2016
--   Exported By:     TRANSPORTATION
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,5040327045175130));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'TRANSPORTATIONWH'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'TRANSPORTATION REPORTING'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F106'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 10246822863815950 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 10247018081815951 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 10250103701815953 + wwv_flow_api.g_id_offset,
  p_error_template=> 10246408736815950 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20161116012429',
  ...
  p_cust_authentication_process=> '.'||to_char(10255712932815957 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 21,
  p_default_label_template => 10254418285815956 + wwv_flow_api.g_id_offset,
  p_default_report_template => 10253710118815956 + wwv_flow_api.g_id_offset,
  p_default_list_template => 10252721495815955 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 10254707620815956 + wwv_flow_api.g_id_offset,
  p_default_button_template => 10247523486815951 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 10249103487815952 + wwv_flow_api.g_id_offset,
  p_default_form_template => 10249221302815952 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 10251016658815953 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 10250103701815953 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>10250103701815953 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 10248627035815952 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 10249029428815952 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 10249724030815952 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'TRANSPORTATION',
  p_last_upd_yyyymmddhh24miss=> '20161116012429',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 10256010481815957 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_tab (
  p_id=> 10257412698815959 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
--application/shared_components/navigation/tabs/standard/crowded_report
wwv_flow_api.create_tab (
  p_id=> 10258300648827011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'Crowded Report',
  p_tab_text => 'Crowded Report',
  p_tab_step => 2,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/2010_bus_report
wwv_flow_api.create_tab (
  p_id=> 10273101380057445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> '2010 Bus Report',
  p_tab_text => '2010 Bus Report',
  p_tab_step => 4,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20161116004242'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 10257520677815959 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'HOME',
  p_region_name=>'',
  p_plug_template=> 10250103701815953+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 10257723249815962 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 10248627035815952+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(10257114344815958 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 10254707620815956+ wwv_flow_api.g_id_offset,
...
prompt  ...PAGE 2: Transport Crowded Report
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 2
 ,p_tab_set => 'TS1'
 ,p_name => 'Transport Crowded Report'
 ,p_step_title => 'Transport Crowded Report'
 ,p_step_sub_title => 'Transport Crowded Report'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'TRANSPORTATION'
 ,p_last_upd_yyyymmddhh24miss => '20161116004625'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 10258412213827011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select t.YEAR,rg.RegionName,l.LOCALAUTHORITYName,r.RoadName,r.STARTJUNCTION,r.ENDJUNCTION, TO_NUMBER(sum(NUMBEROFCARS)) Total_Vehicles from (FACT_TRANSPORTATION fact'||chr(10)||
'INNER JOIN DIM_VEHICLETYPE v on v.VEHICLETYPEID=fact.VEHICLETYPEID'||chr(10)||
'INNER JOIN dim_time t on fact.timeid=t.timeid'||chr(10)||
'INNER JOIN dim_Region rg on fact.RegionId=rg.RegionId'||chr(10)||
'INNER JOIN DIM_LOCALAUTHORITY l on fact.LOCALAUTHORITYID=l.LOCALAUT';

s:=s||'HORITYID'||chr(10)||
'INNER JOIN DIM_ROAD r on fact.SKEY_ROAD=r.SKEY_ROAD) '||chr(10)||
'GROUP BY t.year,rg.RegionName,l.LOCALAUTHORITYName,r.RoadName,r.STARTJUNCTION,r.ENDJUNCTION ORDER BY Total_Vehicles desc;';

wwv_flow_api.create_page_plug (
  p_id=> 10258831661827011 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Report ',
  p_region_name=>'',
  p_plug_template=> 10249724030815952+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
begin
a1:=a1||'select t.YEAR,rg.RegionName,l.LOCALAUTHORITYName,r.RoadName,r.STARTJUNCTION,r.ENDJUNCTION, TO_NUMBER(sum(NUMBEROFCARS)) Total_Vehicles from (FACT_TRANSPORTATION fact'||chr(10)||
'INNER JOIN DIM_VEHICLETYPE v on v.VEHICLETYPEID=fact.VEHICLETYPEID'||chr(10)||
'INNER JOIN dim_time t on fact.timeid=t.timeid'||chr(10)||
'INNER JOIN dim_Region rg on fact.RegionId=rg.RegionId'||chr(10)||
'INNER JOIN DIM_LOCALAUTHORITY l on fact.LOCALAUTHORITYID=l.LOCALAUT';

a1:=a1||'HORITYID'||chr(10)||
'INNER JOIN DIM_ROAD r on fact.SKEY_ROAD=r.SKEY_ROAD) '||chr(10)||
'GROUP BY t.year,rg.RegionName,l.LOCALAUTHORITYName,r.RoadName,r.STARTJUNCTION,r.ENDJUNCTION ORDER BY Total_Vehicles desc;';

wwv_flow_api.create_worksheet(
  p_id=> 10258916783827011+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 10258831661827011+wwv_flow_api.g_id_offset,
  p_name=> 'Report ',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_owner=>'TRANSPORTATION');
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259112915827012+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259216634827015+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  ...
  p_column_label           =>'Regionname',
  p_report_label           =>'Regionname',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259304185827016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'LOCALAUTHORITYNAME',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Localauthorityname',
  p_report_label           =>'Localauthorityname',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259424379827016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ROADNAME',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Roadname',
  p_report_label           =>'Roadname',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259516795827016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'STARTJUNCTION',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Startjunction',
  p_report_label           =>'Startjunction',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259614978827016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ENDJUNCTION',
  p_display_order          =>6,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'F',
  p_column_label           =>'Endjunction',
  p_report_label           =>'Endjunction',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10259731390827016+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TOTAL_VEHICLES',
  p_display_order          =>7,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'G',
  p_column_label           =>'Total Vehicles',
  p_report_label           =>'Total Vehicles',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'YEAR:REGIONNAME:LOCALAUTHORITYNAME:ROADNAME:STARTJUNCTION:ENDJUNCTION:TOTAL_VEHICLES';

wwv_flow_api.create_worksheet_rpt(
  p_id => 10259816515827206+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 10258916783827011+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
prompt  ...PAGE 4: ReportMotorcycle
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 4
 ,p_tab_set => 'TS1'
 ,p_name => 'ReportMotorcycle'
 ,p_step_title => 'ReportMotorcycle'
 ,p_step_sub_title => 'ReportMotorcycle'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'TRANSPORTATION'
 ,p_last_upd_yyyymmddhh24miss => '20161116012257'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 10273228133057445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select t.YEAR,rg.RegionName,l.LOCALAUTHORITYName,sum(NUMBEROFBUSCOACHES) Total_Buses,sum(NUMBEROFCARS)Total_Cars,TO_NUMBER(sum(NUMBEROFCARS)-sum(NUMBEROFBUSCOACHES)) Difference from FACT_TRANSPORTATION fact'||chr(10)||
'INNER JOIN DIM_VEHICLETYPE v on v.VEHICLETYPEID=fact.VEHICLETYPEID'||chr(10)||
'INNER JOIN dim_time t on fact.timeid=t.timeid'||chr(10)||
'INNER JOIN dim_Region rg on fact.RegionId=rg.RegionId'||chr(10)||
'INNER JOIN DIM_LOCALAUTHOR';

s:=s||'ITY l on fact.LOCALAUTHORITYID=l.LOCALAUTHORITYID'||chr(10)||
'WHERE rg.REGIONNAME=''Yorkshire and The Humber'' AND t.YEAR=''2010'' GROUP BY t.year,rg.RegionName,l.LOCALAUTHORITYName;';

wwv_flow_api.create_page_plug (
  p_id=> 10273626686057445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Report',
  p_region_name=>'',
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select t.YEAR,rg.RegionName,l.LOCALAUTHORITYName,sum(NUMBEROFBUSCOACHES) Total_Buses,sum(NUMBEROFCARS)Total_Cars,TO_NUMBER(sum(NUMBEROFCARS)-sum(NUMBEROFBUSCOACHES)) Difference from FACT_TRANSPORTATION fact'||chr(10)||
'INNER JOIN DIM_VEHICLETYPE v on v.VEHICLETYPEID=fact.VEHICLETYPEID'||chr(10)||
'INNER JOIN dim_time t on fact.timeid=t.timeid'||chr(10)||
'INNER JOIN dim_Region rg on fact.RegionId=rg.RegionId'||chr(10)||
'INNER JOIN DIM_LOCALAUTHOR';

a1:=a1||'ITY l on fact.LOCALAUTHORITYID=l.LOCALAUTHORITYID'||chr(10)||
'WHERE rg.REGIONNAME=''Yorkshire and The Humber'' AND t.YEAR=''2010'' GROUP BY t.year,rg.RegionName,l.LOCALAUTHORITYName;';

wwv_flow_api.create_worksheet(
  p_id=> 10273707935057445+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_region_id=> 10273626686057445+wwv_flow_api.g_id_offset,
  p_name=> 'Report',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10273909315057445+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'YEAR',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10274000446057449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'REGIONNAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10274103702057449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'LOCALAUTHORITYNAME',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10274210012057449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TOTAL_BUSES',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Total Buses',
  p_report_label           =>'Total Buses',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10274301550057449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'TOTAL_CARS',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Total Cars',
  p_report_label           =>'Total Cars',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 10274429632057449+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'YEAR:REGIONNAME:LOCALAUTHORITYNAME:TOTAL_BUSES:TOTAL_CARS:DIFFERENCE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 10274527971057654+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_worksheet_id => 10273707935057445+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 10246028854815949 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 10256304085815957 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
  p_plug_template=> 10249221302815952+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_page_item(
  p_id=>10256426500815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 10256304085815957+wwv_flow_api.g_id_offset,
  ...
  p_field_template=> 10254418285815956+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>10256531853815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>10256609508815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(10247523486815951 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 10256824258815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 10256714194815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 10257001847815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 10256915949815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 10257114344815958 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>10257624705815961 + wwv_flow_api.g_id_offset,
  p_menu_id=>10257114344815958 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>10258728431827011 + wwv_flow_api.g_id_offset,
  p_menu_id=>10257114344815958 + wwv_flow_api.g_id_offset,
  p_parent_id=>10257624705815961 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Transport Crowded Report',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>10273525423057445 + wwv_flow_api.g_id_offset,
  p_menu_id=>10257114344815958 + wwv_flow_api.g_id_offset,
  p_parent_id=>10257624705815961 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'ReportMotorcycle',
  p_long_name=>'',
...
prompt  ......Page template 10246028854815949
...
wwv_flow_api.create_template(
  p_id=> 10246028854815949 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 10246102507815949
...
wwv_flow_api.create_template(
  p_id=> 10246102507815949 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246211207815950
...
wwv_flow_api.create_template(
  p_id=> 10246211207815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246300612815950
...
wwv_flow_api.create_template(
  p_id=> 10246300612815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246408736815950
...
wwv_flow_api.create_template(
  p_id=> 10246408736815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246516432815950
...
wwv_flow_api.create_template(
  p_id=> 10246516432815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246613979815950
...
wwv_flow_api.create_template(
  p_id=> 10246613979815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246722298815950
...
wwv_flow_api.create_template(
  p_id=> 10246722298815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246822863815950
...
wwv_flow_api.create_template(
  p_id=> 10246822863815950 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10246922166815951
...
wwv_flow_api.create_template(
  p_id=> 10246922166815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 10247018081815951
...
wwv_flow_api.create_template(
  p_id=> 10247018081815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10247119998815951
...
wwv_flow_api.create_template(
  p_id=> 10247119998815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10247214934815951
...
wwv_flow_api.create_template(
  p_id=> 10247214934815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10247327401815951
...
wwv_flow_api.create_template(
  p_id=> 10247327401815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 10247429116815951
...
wwv_flow_api.create_template(
  p_id=> 10247429116815951 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template