...
prompt  APPLICATION 106 - PlaceUclient
--
-- Application Export:
--   Application:     106
--   Name:            PlaceUclient
--   Date and Time:   20:08 Wednesday March 29, 2017
--   Exported By:     CONTRACTORPROJECT
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,4984317453635324));
...
begin
   ...
   -- Remove Application
wwv_flow_api.remove_flow(nvl(wwv_flow_application_install.get_application_id,106));
...
wwv_flow_audit.remove_audit_trail(nvl(wwv_flow_application_install.get_application_id,106));
null;
...
wwv_flow_api.create_flow(
  p_id    => nvl(wwv_flow_application_install.get_application_id,106),
  p_display_id=> nvl(wwv_flow_application_install.get_application_id,106),
  p_owner => nvl(wwv_flow_application_install.get_schema,'CONTRACTORPROJECT'),
  p_name  => nvl(wwv_flow_application_install.get_application_name,'PlaceUclient'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F106'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 5126514363707392 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 5126731882707392 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5129004589707399 + wwv_flow_api.g_id_offset,
  p_error_template=> 5126514363707392 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20170325132603',
  ...
  p_cust_authentication_process=> '.'||to_char(5133905389707432 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 1,
  p_default_label_template => 5132412038707418 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5131702232707416 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5131021089707409 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5132709770707419 + wwv_flow_api.g_id_offset,
  p_default_button_template => 5127219994707394 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5128126632707398 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5128230266707398 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5129605457707405 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5129004589707399 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5129004589707399 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 5127807977707397 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5128411210707398 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5128709653707399 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'CONTRACTORPROJECT',
  p_last_upd_yyyymmddhh24miss=> '20170325132603',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5134017185707432 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 5139724492093638 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 5135406219707444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_HOME',
...
--application/shared_components/navigation/tabs/standard/my_companies
wwv_flow_api.create_tab (
  p_id=> 5200203336225503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> 'My Companies',
  p_tab_text => 'My Companies',
  p_tab_step => 13,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/view_placements
wwv_flow_api.create_tab (
  p_id=> 5247024225975332 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 50,
  p_tab_name=> 'View Placements',
  p_tab_text => 'View Placements',
  p_tab_step => 16,
  p_tab_also_current_for_pages => '17',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/my_skills
wwv_flow_api.create_tab (
  p_id=> 5407501017618634 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 80,
  p_tab_name=> 'My Skills',
  p_tab_text => 'My Skills',
  p_tab_step => 6,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/my_current_info
wwv_flow_api.create_tab (
  p_id=> 5410031914652100 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 90,
  p_tab_name=> 'My Current Info',
  p_tab_text => 'My Current Info',
  p_tab_step => 7,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
...
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20170122220344'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 5135505947707445 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'HOME',
  p_region_name=>'',
  p_plug_template=> 5129004589707399+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5135710072707447 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 5127807977707397+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(5135112361707442 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 5132709770707419+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'My Skills'
 ,p_step_title => 'My Skills'
 ,p_step_sub_title => 'My Skills'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5407622788618634 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
...
begin
s:=s||'select     '||chr(10)||
'LDS_PKG.getSkillNmae(CON_SKILL_1) skill1,'||chr(10)||
'LDS_PKG.getSkillNmae(CON_SKILL_2) skill2,'||chr(10)||
'LDS_PKG.getSkillNmae(CON_SKILL_3) skill3'||chr(10)||
'from "#OWNER#"."LDS_CONTRACTOR" '||chr(10)||
' where CONTRACTOR_ID in (select CONTRACTOR_ID FROM PLACEUSER where upper(USERNAME)=upper(:APP_USER))';

wwv_flow_api.create_page_plug (
  p_id=> 5408006808618635 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_plug_name=> 'My Skills',
  p_region_name=>'',
  p_plug_template=> 5128709653707399+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
wwv_flow_api.create_worksheet(
  p_id=> 5408122411618635+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_region_id=> 5408006808618635+wwv_flow_api.g_id_offset,
  p_name=> 'My Skills',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_owner=>'CONTRACTORPROJECT');
end;
/
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5408322371618637+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5408122411618635+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SKILL1',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Skill1',
  p_report_label           =>'Skill1',
  p_sync_form_label        =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5408430505618638+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5408122411618635+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SKILL2',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Skill2',
  p_report_label           =>'Skill2',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5408527367618638+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5408122411618635+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'SKILL3',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Skill3',
  p_report_label           =>'Skill3',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
rc1:=rc1||'SKILL1:SKILL2:SKILL3';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5408625998619328+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 6,
  p_worksheet_id => 5408122411618635+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_page (
 ...
 ,p_id => 7
 ,p_tab_set => 'TS1'
 ,p_name => 'My Current Info'
 ,p_step_title => 'My Current Info'
 ,p_step_sub_title => 'My Current Info'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170325125817'
  );
null;
...
begin
s:=s||'select     '||chr(10)||
'LDS_PKG.getMaxJoinDate(CONTRACTOR_ID) JoinDate,'||chr(10)||
'LDS_PKG.get_sal(CONTRACTOR_ID) salary,'||chr(10)||
'LDS_PKG. getCurrentCompany(CONTRACTOR_ID) Company'||chr(10)||
'from "#OWNER#"."LDS_CONTRACTOR" '||chr(10)||
'WHERE CONTRACTOR_ID in (select CONTRACTOR_ID FROM PLACEUSER where upper(USERNAME)=upper(:APP_USER))';

wwv_flow_api.create_page_plug (
  p_id=> 5410118617652100 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_plug_name=> 'My Current Info',
  p_region_name=>'',
  p_plug_template=> 5128709653707399+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
...
wwv_flow_api.create_worksheet(
  p_id=> 5410219493652100+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_region_id=> 5410118617652100+wwv_flow_api.g_id_offset,
  p_name=> 'My Current Info',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5410426323652106+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_worksheet_id => 5410219493652100+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'JOINDATE',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Joindate',
  p_report_label           =>'Joindate',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5410526344652107+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_worksheet_id => 5410219493652100+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5410612546652107+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_worksheet_id => 5410219493652100+wwv_flow_api.g_id_offset,
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'JOINDATE:SALARY:COMPANY';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5410710246652649+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 7,
  p_worksheet_id => 5410219493652100+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170125012923'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5200301725225503 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select	 acc.ACC_NAME as Company,'||chr(10)||
'acc.ACC_POSTCODE'||chr(10)||
' from	 PLACEUSER usr,'||chr(10)||
'	 LDS_PLACEMENT plc,'||chr(10)||
'	 LDS_CONTRACTOR con,'||chr(10)||
'         LDS_JOB_ROLE rl,'||chr(10)||
'LDS_ACCOUNT acc'||chr(10)||
'Where con.CONTRACTOR_ID=plc.FK2_CONTRACTOR_ID AND rl.JOB_ROLE_ID=plc.FK3_JOB_ROLE_ID AND usr.CONTRACTOR_ID=con.CONTRACTOR_ID AND upper(usr.USERNAME)=upper(V(''APP_USER'')) AND acc.ACCOUNT_ID=plc.FK1_ACCOUNT_ID Group By acc.Acc_Name,acc.ACC_POSTC';

s:=s||'ODE';

wwv_flow_api.create_page_plug (
  p_id=> 5200701260225504 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select	 acc.ACC_NAME as Company,'||chr(10)||
'acc.ACC_POSTCODE'||chr(10)||
' from	 PLACEUSER usr,'||chr(10)||
'	 LDS_PLACEMENT plc,'||chr(10)||
'	 LDS_CONTRACTOR con,'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5200819462225504+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_region_id=> 5200701260225504+wwv_flow_api.g_id_offset,
  p_name=> 'Report 1',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5201000074225508+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5200819462225504+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'COMPANY',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5201131585225511+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5200819462225504+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ACC_POSTCODE',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Acc Postcode',
  p_report_label           =>'Acc Postcode',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'COMPANY:ACC_POSTCODE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5201225521225799+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 13,
  p_worksheet_id => 5200819462225504+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
prompt  ...PAGE 15: Form on LDS_PLACEMENT
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 15
 ,p_tab_set => 'TS1'
 ,p_name => 'Form on LDS_PLACEMENT'
 ,p_step_title => 'Form on LDS_PLACEMENT'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_javascript_code => 
...
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170323211237'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5231808300945854 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_plug_name=> 'Lds Placement',
  p_region_name=>'',
  p_plug_template=> 5128230266707398+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5238517723945902 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 15,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5232120600945854 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
  p_button_sequence=> 30,
  p_button_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5127219994707394+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P15_PLACEMENT_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5232411110945854 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
...
wwv_flow_api.create_page_button(
  p_id             => 5232023320945854 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
...
wwv_flow_api.create_page_button(
  p_id             => 5232221780945854 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 15,
...
wwv_flow_api.create_page_branch(
  p_id=>5233013607945855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
...
wwv_flow_api.create_page_item(
  p_id=>5233205321945855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLACEMENT_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Placement Id',
  p_source=>'PLACEMENT_ID',
  ...
  p_field_template=> 5132412038707418+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'Y',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>5233430025945855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_SHORT_DESC',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 2,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt Short Desc',
  p_source=>'PLT_SHORT_DESC',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5233617250945855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_REQUIRED_START_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt Required Start Date',
  p_source=>'PLT_REQUIRED_START_DATE',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5233802373945855 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_ESTIMATED_END_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt Estimated End Date',
  p_source=>'PLT_ESTIMATED_END_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5234012986945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PTL_ACTUAL_START_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 5,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Ptl Actual Start Date',
  p_source=>'PTL_ACTUAL_START_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5234215103945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_ACTUAL_END_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 6,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt Actual End Date',
  p_source=>'PLT_ACTUAL_END_DATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DATE_PICKER',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5234425677945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_RENEWAL_NO',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 7,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt Renewal No',
  p_source=>'PLT_RENEWAL_NO',
  p_source_type=> 'DB_COLUMN',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5234604514945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_PLT_TO_PERMANENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 8,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Plt To Permanent',
  p_source=>'PLT_TO_PERMANENT',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_TEXT_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5234828473945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_MAX_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 9,
  ...
  p_label_alignment=> 'RIGHT',
  p_field_alignment=> 'LEFT',
  p_field_template=> 5132626431707419+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_03 => 'right',
  p_item_comment => '');
...
begin
wwv_flow_api.create_page_item(
  p_id=>5235025497945856 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_MIN_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5235203303945857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 15,
  p_name=>'P15_ACTUAL_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 11,
  p_item_plug_id => 5231808300945854+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
  p_prompt=>'Actual Salary',
  p_source=>'ACTUAL_SALARY',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_NUMBER_FIELD',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:LDS_PLACEMENT:P15_PLACEMENT_ID:PLACEMENT_ID';

wwv_flow_api.create_page_process(
  p_id     => 5235531659945857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 15,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
  p_process_type=> 'DML_FETCH_ROW',
  p_process_name=> 'Fetch Row from LDS_PLACEMENT',
...
'  is '||chr(10)||
'  begin '||chr(10)||
'    for c1 in (select SEQ_PLACEMENT.nextval next_val'||chr(10)||
'               from dual)'||chr(10)||
'    loop'||chr(10)||
...
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P15_PLACEMENT_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5235717967945857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 15,
  p_process_sequence=> 10,
  ...
  p_process_when_button_id=>5232023320945854 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:LDS_PLACEMENT:P15_PLACEMENT_ID:PLACEMENT_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5235932657945857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 15,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
  p_process_type=> 'DML_PROCESS_ROW',
  p_process_name=> 'Process Row of LDS_PLACEMENT',
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process row of table LDS_PLACEMENT.',
...
wwv_flow_api.create_page_process(
  p_id     => 5236128639945857 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 15,
  ...
  p_process_when_button_id=>5232221780945854 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
prompt  ...PAGE 16: Report on LDS_PLACEMENT
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 16
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on LDS_PLACEMENT'
 ,p_step_title => 'Report on LDS_PLACEMENT'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170125090721'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "PLACEMENT_ID", '||chr(10)||
'"PLT_SHORT_DESC",'||chr(10)||
'"PLT_REQUIRED_START_DATE",'||chr(10)||
'"PLT_ESTIMATED_END_DATE",'||chr(10)||
'"PTL_ACTUAL_START_DATE",'||chr(10)||
'"PLT_ACTUAL_END_DATE",'||chr(10)||
'"PLT_RENEWAL_NO",'||chr(10)||
'"PLT_TO_PERMANENT",'||chr(10)||
'"MAX_SALARY",'||chr(10)||
'"MIN_SALARY",'||chr(10)||
'"ACTUAL_SALARY",'||chr(10)||
'"FK1_ACCOUNT_ID",'||chr(10)||
'"FK2_CONTRACTOR_ID",'||chr(10)||
'"FK3_JOB_ROLE_ID",'||chr(10)||
'"CREATEDBY",'||chr(10)||
'"CREATEDDATE",'||chr(10)||
'"UPDATEDBY",'||chr(10)||
'"UPDATEDDATE"'||chr(10)||
'from "#OWNER#"."LDS_PLACEMENT" '||chr(10)||
' where FK2_CONTRACTOR_ID in (';

s:=s||'select CONTRACTOR_ID FROM PLACEUSER where upper(USERNAME)=upper(:APP_USER)) '||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_page_plug (
  p_id=> 5253406635975340 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_plug_name=> 'Lds Placement',
  p_region_name=>'',
...
declare
 a1 varchar2(32767) := null;
begin
a1:=a1||'select "PLACEMENT_ID", '||chr(10)||
'"PLT_SHORT_DESC",'||chr(10)||
'"PLT_REQUIRED_START_DATE",'||chr(10)||
'"PLT_ESTIMATED_END_DATE",'||chr(10)||
'"PTL_ACTUAL_START_DATE",'||chr(10)||
...
a1:=a1||'select CONTRACTOR_ID FROM PLACEUSER where upper(USERNAME)=upper(:APP_USER)) '||chr(10)||
'  '||chr(10)||
'';

wwv_flow_api.create_worksheet(
  p_id=> 5253607800975340+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_region_id=> 5253406635975340+wwv_flow_api.g_id_offset,
  p_name=> 'Lds Placement',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  p_max_row_count=> '10000',
  ...
  p_show_help=>'Y',
  p_download_formats=>'CSV:HTML:EMAIL',
  p_detail_link=>'f?p=&APP_ID.:17:&APP_SESSION.::::P17_PLACEMENT_ID:#PLACEMENT_ID#',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5253719653975341+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLACEMENT_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Placement Id',
  p_report_label           =>'Placement Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5253812647975343+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_SHORT_DESC',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Plt Short Desc',
  p_report_label           =>'Plt Short Desc',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5253905853975344+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_REQUIRED_START_DATE',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Plt Required Start Date',
  p_report_label           =>'Plt Required Start Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254002479975344+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_ESTIMATED_END_DATE',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Plt Estimated End Date',
  p_report_label           =>'Plt Estimated End Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254115211975344+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PTL_ACTUAL_START_DATE',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Ptl Actual Start Date',
  p_report_label           =>'Ptl Actual Start Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254223903975345+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_ACTUAL_END_DATE',
  p_display_order          =>6,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'F',
  p_column_label           =>'Plt Actual End Date',
  p_report_label           =>'Plt Actual End Date',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254330589975345+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_RENEWAL_NO',
  p_display_order          =>7,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'G',
  p_column_label           =>'Plt Renewal No',
  p_report_label           =>'Plt Renewal No',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254425184975346+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PLT_TO_PERMANENT',
  p_display_order          =>8,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'H',
  p_column_label           =>'Plt To Permanent',
  p_report_label           =>'Plt To Permanent',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254524620975346+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254601162975346+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254707119975347+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'ACTUAL_SALARY',
  p_display_order          =>11,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'K',
  p_column_label           =>'Actual Salary',
  p_report_label           =>'Actual Salary',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254802079975347+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FK1_ACCOUNT_ID',
  p_display_order          =>12,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'L',
  p_column_label           =>'Fk1 Account Id',
  p_report_label           =>'Fk1 Account Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5254906464975347+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FK2_CONTRACTOR_ID',
  p_display_order          =>13,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'M',
  p_column_label           =>'Fk2 Contractor Id',
  p_report_label           =>'Fk2 Contractor Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5255011418975348+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'FK3_JOB_ROLE_ID',
  p_display_order          =>14,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'N',
  p_column_label           =>'Fk3 Job Role Id',
  p_report_label           =>'Fk3 Job Role Id',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5255130606975348+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5255203096975348+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CREATEDDATE',
  p_display_order          =>16,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'P',
  p_column_label           =>'Createddate',
  p_report_label           =>'Createddate',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5255309656975349+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5255406589975349+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'UPDATEDDATE',
  p_display_order          =>18,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'R',
  p_column_label           =>'Updateddate',
  p_report_label           =>'Updateddate',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
declare
    rc1 varchar2(32767) := null;
begin
rc1:=rc1||'PLACEMENT_ID:PLT_SHORT_DESC:PLT_REQUIRED_START_DATE:PLT_ESTIMATED_END_DATE:PTL_ACTUAL_START_DATE:PLT_ACTUAL_END_DATE:PLT_RENEWAL_NO:PLT_TO_PERMANENT:MAX_SALARY:MIN_SALARY:ACTUAL_SALARY:FK1_ACCOUNT_ID:FK2_CONTRACTOR_ID:FK3_JOB_ROLE_ID:CREATEDBY:CREATEDDATE:UPDATEDBY:UPDATEDDATE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5256505123975539+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_worksheet_id => 5253607800975340+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5255721989975349 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 16,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5255611586975349 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 16,
  p_button_sequence=> 30,
  p_button_plug_id => 5253406635975340+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5127219994707394+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Create',
  p_button_position=> 'RIGHT_OF_IR_SEARCH_BAR',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'f?p=106:17:&SESSION.::&DEBUG.:17',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
prompt  ...PAGE 17: Form on LDS_PLACEMENT
--
...
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170128082414'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5247116476975332 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_plug_name=> 'Lds Placement',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5255927581975349 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 17,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5247429608975333 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 17,
  p_button_sequence=> 30,
  p_button_plug_id => 5247116476975332+wwv_flow_api.g_id_offset,
  p_button_name    => 'SAVE',
  p_button_image   => 'template:'||to_char(5127219994707394+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Apply Changes',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
  ...
  p_button_redirect_url=> '',
  p_button_execute_validations=>'Y',
  p_button_condition=> 'P17_PLACEMENT_ID',
  p_button_condition_type=> 'ITEM_IS_NOT_NULL',
  p_database_action=>'UPDATE',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 5247700922975333 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 17,
  p_button_sequence=> 10,
  p_button_plug_id => 5247116476975332+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5247316707975333 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 17,
  p_button_sequence=> 40,
  p_button_plug_id => 5247116476975332+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5247522102975333 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 17,
  p_button_sequence=> 20,
  p_button_plug_id => 5247116476975332+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>5248324768975334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5248517462975334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLACEMENT_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 1,
  p_item_plug_id => 5247116476975332+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'NO',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5248714282975334 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_SHORT_DESC',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 2,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5248911806975335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_REQUIRED_START_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 3,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5249116104975335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_ESTIMATED_END_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 4,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5249320784975335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PTL_ACTUAL_START_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 5,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5249503167975335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_ACTUAL_END_DATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 6,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5249702500975335 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_RENEWAL_NO',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 7,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5249916076975336 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_PLT_TO_PERMANENT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 8,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5250101734975336 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_MAX_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 9,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5250318865975336 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_MIN_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5250509318975336 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_ACTUAL_SALARY',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 11,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5250718327975336 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_FK1_ACCOUNT_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 12,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Fk1 Account Id',
  p_source=>'FK1_ACCOUNT_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5250910775975337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_FK2_CONTRACTOR_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 13,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Fk2 Contractor Id',
  p_source=>'FK2_CONTRACTOR_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5251113413975337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_FK3_JOB_ROLE_ID',
  p_data_type=> 'VARCHAR',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 14,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Fk3 Job Role Id',
  p_source=>'FK3_JOB_ROLE_ID',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5251327663975337 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5251525851975338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_CREATEDDATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 16,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Createddate',
  p_source=>'CREATEDDATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5251730604975338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_UPDATEDBY',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 17,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5251912597975338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 17,
  p_name=>'P17_UPDATEDDATE',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 18,
  ...
  p_use_cache_before_default=> 'NO',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Updateddate',
  p_source=>'UPDATEDDATE',
  p_source_type=> 'DB_COLUMN',
  p_display_as=> 'NATIVE_DISPLAY_ONLY',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
...
declare
  ...
  l_length number := 1;
begin
p:=p||'F|#OWNER#:LDS_PLACEMENT:P17_PLACEMENT_ID:PLACEMENT_ID';

wwv_flow_api.create_page_process(
  p_id     => 5252207806975338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 17,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_HEADER',
...
'  is '||chr(10)||
'  begin '||chr(10)||
'    for c1 in (select SEQ_PLACEUSER.nextval next_val'||chr(10)||
'               from dual)'||chr(10)||
'    loop'||chr(10)||
'        return c1.next_val;'||chr(10)||
'    end loop;'||chr(10)||
'  end; '||chr(10)||
'begin '||chr(10)||
'  :P17_PLACEMENT_ID := get_pk; '||chr(10)||
'end; ';

wwv_flow_api.create_page_process(
  p_id     => 5252409180975338 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 17,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to get primary key item value.',
  p_process_when_button_id=>5247316707975333 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#:LDS_PLACEMENT:P17_PLACEMENT_ID:PLACEMENT_ID|IUD';

wwv_flow_api.create_page_process(
  p_id     => 5252614966975339 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 17,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5252812345975339 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 17,
  p_process_sequence=> 40,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>5247522102975333 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 5125703876707376 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5134325803707438 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5134429903707439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5134325803707438+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5134523832707440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5134618602707440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(5127219994707394 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 5134830323707442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5134704705707440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5135019424707442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5134922675707442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 5135112361707442 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>5135602430707447 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>5200624556225504 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>5135602430707447 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>5239013765945910 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>5238721027945902 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Form on LDS_PLACEMENT',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5256108455975349 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>5135602430707447 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Report on LDS_PLACEMENT',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5256401696975349 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>5256108455975349 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Form on LDS_PLACEMENT',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5407918893618634 + wwv_flow_api.g_id_offset,
  p_menu_id=>5135112361707442 + wwv_flow_api.g_id_offset,
  p_parent_id=>5135602430707447 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'My Skills',
  p_long_name=>'',
...
prompt  ......Page template 5125703876707376
...
wwv_flow_api.create_template(
  p_id=> 5125703876707376 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 5125800853707383
...
wwv_flow_api.create_template(
  p_id=> 5125800853707383 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5125913714707387
...
wwv_flow_api.create_template(
  p_id=> 5125913714707387 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126023970707388
...
wwv_flow_api.create_template(
  p_id=> 5126023970707388 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126108660707390
...
wwv_flow_api.create_template(
  p_id=> 5126108660707390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126223057707390
...
wwv_flow_api.create_template(
  p_id=> 5126223057707390 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126329396707391
...
wwv_flow_api.create_template(
  p_id=> 5126329396707391 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126404525707391
...
wwv_flow_api.create_template(
  p_id=> 5126404525707391 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126514363707392
...
wwv_flow_api.create_template(
  p_id=> 5126514363707392 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126619320707392
...
wwv_flow_api.create_template(
  p_id=> 5126619320707392 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 5126731882707392
...
wwv_flow_api.create_template(
  p_id=> 5126731882707392 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126820473707392
...
wwv_flow_api.create_template(
  p_id=> 5126820473707392 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5126900588707393
...
wwv_flow_api.create_template(
  p_id=> 5126900588707393 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5127023028707393
...
wwv_flow_api.create_template(
  p_id=> 5127023028707393 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5127119818707394
...
wwv_flow_api.create_template(
  p_id=> 5127119818707394 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 5127219994707394
declare
...
wwv_flow_api.create_button_templates (
  p_id=>5127219994707394 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5127330408707396
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5127330408707396 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5127431951707396
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5127431951707396 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5127531606707396
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5127531606707396 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 5127616475707396
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5127616475707396 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5127725744707397
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5127725744707397 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5127807977707397
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5127807977707397 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5127918988707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5127918988707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5128001237707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128001237707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5128126632707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128126632707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5128230266707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128230266707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5128319695707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128319695707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5128411210707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128411210707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5128511790707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128511790707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5128602761707398
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128602761707398 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5128709653707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128709653707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5128822855707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128822855707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5128912603707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5128912603707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5129004589707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129004589707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5129111251707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129111251707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5129215354707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129215354707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5129323928707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129323928707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5129428932707399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129428932707399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5129501990707404
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129501990707404 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5129605457707405
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129605457707405 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5129717861707405
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5129717861707405 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......list template 5129802289707405
...
wwv_flow_api.create_list_template (
  p_id=>5129802289707405 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5129903426707407
...
wwv_flow_api.create_list_template (
  p_id=>5129903426707407 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130003797707408
...
wwv_flow_api.create_list_template (
  p_id=>5130003797707408 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130122598707408
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130122598707408 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130209370707408
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130209370707408 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130325792707408
...
wwv_flow_api.create_list_template (
  p_id=>5130325792707408 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130422725707409
...
wwv_flow_api.create_list_template (
  p_id=>5130422725707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130515503707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130515503707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130609888707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130609888707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130718819707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130718819707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130819958707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130819958707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5130918481707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5130918481707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5131021089707409
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5131021089707409 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5131128460707410
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5131128460707410 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5131206379707410
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5131206379707410 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5131313701707410
...
wwv_flow_api.create_row_template (
  p_id=> 5131313701707410 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131419500707415
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131419500707415 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131521887707415
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131521887707415 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131605680707415
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131605680707415 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131702232707416
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131702232707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131811459707416
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131811459707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5131906453707416
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5131906453707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5132028668707416
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5132028668707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5132120247707416
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5132120247707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5132217431707416
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5132217431707416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5132303299707418
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5132303299707418 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5132412038707418
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5132412038707418 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5132509373707419
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5132509373707419 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5132626431707419
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5132626431707419 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5132709770707419
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5132709770707419 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5132815528707424
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5132815528707424 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5133519455707427
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5133519455707427 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5132911194707424
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5132911194707424 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5133102848707426
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5133102848707426 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5133325446707426
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5133325446707426 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5133604497707429
begin
wwv_flow_api.create_theme (
  p_id =>5133604497707429 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 1,
  ...
  p_login_template=>5125703876707376 + wwv_flow_api.g_id_offset,
  p_default_button_template=>5127219994707394 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5129004589707399 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5128126632707398 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5128230266707398 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5132412038707418 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5132709770707419 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5132911194707424 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5131021089707409 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5132412038707418 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5132626431707419 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ...dynamic translations used by application: 106
--
...
wwv_flow_api.create_shortcut (
 p_id=> 5177728836927664 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5133701894707432
...
wwv_flow_api.create_auth_setup (
  p_id=> 5133701894707432 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5133802240707432
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5133802240707432 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5133905389707432
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5133905389707432 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
