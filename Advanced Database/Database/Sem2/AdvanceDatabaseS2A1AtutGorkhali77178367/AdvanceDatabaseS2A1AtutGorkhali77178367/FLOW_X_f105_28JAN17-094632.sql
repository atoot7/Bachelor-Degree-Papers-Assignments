...
prompt  APPLICATION 105 - PlaceUAdmin
--
-- Application Export:
--   Application:     105
--   Name:            PlaceUAdmin
--   Date and Time:   09:46 Saturday January 28, 2017
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'PlaceUAdmin'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F105'),
  p_page_view_logging => 'YES',
  p_default_page_template=> 5085611845181693 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 5085810250181693 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 5088105898181699 + wwv_flow_api.g_id_offset,
  p_error_template=> 5085611845181693 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20170124233853',
  ...
  p_cust_authentication_process=> '.'||to_char(5093026691181711 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 1,
  p_default_label_template => 5091530618181705 + wwv_flow_api.g_id_offset,
  p_default_report_template => 5090816442181704 + wwv_flow_api.g_id_offset,
  p_default_list_template => 5090122379181703 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 5091810696181705 + wwv_flow_api.g_id_offset,
  p_default_button_template => 5086323113181695 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 5087213069181698 + wwv_flow_api.g_id_offset,
  p_default_form_template => 5087321151181698 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 5088707575181700 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 5088105898181699 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>5088105898181699 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 5086907173181697 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 5087501999181699 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 5087807443181699 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'CONTRACTORPROJECT',
  p_last_upd_yyyymmddhh24miss=> '20170124233853',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 5093110180181711 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 5102723951204049 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--application/shared_components/navigation/tabs/standard/t_admin_home
wwv_flow_api.create_tab (
  p_id=> 5094506969181717 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_ADMIN_HOME',
  p_tab_text => 'Admin Home',
  p_tab_step => 1,
  p_tab_also_current_for_pages => '',
  p_tab_parent_tabset=>'',
  p_tab_comment  => '');
 
--application/shared_components/navigation/tabs/standard/contractors
wwv_flow_api.create_tab (
  p_id=> 5095725602203683 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
  p_tab_name=> 'Contractors',
  p_tab_text => 'Contractors',
  p_tab_step => 2,
...
wwv_flow_api.create_tab (
  p_id=> 5141914186024970 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 30,
  p_tab_name=> 'Users',
...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Admin Home'
 ,p_step_title => 'Admin Home'
 ,p_step_sub_title => 'Admin Home'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_upd_yyyymmddhh24miss => '20170122203606'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 5094603130181717 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Admin Home',
  p_region_name=>'',
  p_plug_template=> 5088105898181699+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5094813996181719 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 5086907173181697+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(5094217492181715 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 5091810696181705+ wwv_flow_api.g_id_offset,
...
prompt  ...PAGE 2: Report on LDS_CONTRACTOR
--
...
wwv_flow_api.create_page (
 ...
 ,p_id => 2
 ,p_tab_set => 'TS1'
 ,p_name => 'Report on LDS_CONTRACTOR'
 ,p_step_title => 'Report on LDS_CONTRACTOR'
 ,p_step_sub_title_type => 'TEXT_WITH_SUBSTITUTIONS'
 ,p_include_apex_css_js_yn => 'Y'
 ,p_cache_page_yn => 'N'
 ,p_help_text => 
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170122223051'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select "CONTRACTOR_ID", '||chr(10)||
'"CON_NAME",'||chr(10)||
'"CON_POSTCODE",'||chr(10)||
'"CON_SKILL_1",'||chr(10)||
'"CON_SKILL_2",'||chr(10)||
...
wwv_flow_api.create_page_plug (
  p_id=> 5100429179203708 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_plug_name=> 'Report on LDS_CONTRACTOR',
  p_region_name=>'',
  p_plug_template=> 5087807443181699+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
begin
a1:=a1||'select "CONTRACTOR_ID", '||chr(10)||
'"CON_NAME",'||chr(10)||
'"CON_POSTCODE",'||chr(10)||
'"CON_SKILL_1",'||chr(10)||
'"CON_SKILL_2",'||chr(10)||
...
wwv_flow_api.create_worksheet(
  p_id=> 5100604216203712+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_region_id=> 5100429179203708+wwv_flow_api.g_id_offset,
  p_name=> 'Report on LDS_CONTRACTOR',
  p_folder_id=> null, 
  p_alias=> '',
  p_report_id_item=> '',
  ...
  p_detail_link=>'f?p=&APP_ID.:3:&APP_SESSION.::::P3_CONTRACTOR_ID:#CONTRACTOR_ID#',
...
wwv_flow_api.create_worksheet_column(
  p_id => 5100712267203718+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CONTRACTOR_ID',
  p_display_order          =>1,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'A',
  p_column_label           =>'Contractor Id',
  p_report_label           =>'Contractor Id',
  p_sync_form_label        =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5100822394203726+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CON_NAME',
  p_display_order          =>2,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'B',
  p_column_label           =>'Con Name',
  p_report_label           =>'Con Name',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5100915691203727+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CON_POSTCODE',
  p_display_order          =>3,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'C',
  p_column_label           =>'Con Postcode',
  p_report_label           =>'Con Postcode',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101014442203727+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CON_SKILL_1',
  p_display_order          =>4,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'D',
  p_column_label           =>'Con Skill 1',
  p_report_label           =>'Con Skill 1',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101119189203728+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CON_SKILL_2',
  p_display_order          =>5,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'E',
  p_column_label           =>'Con Skill 2',
  p_report_label           =>'Con Skill 2',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101211129203729+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'CON_SKILL_3',
  p_display_order          =>6,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'F',
  p_column_label           =>'Con Skill 3',
  p_report_label           =>'Con Skill 3',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101321085203729+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'HIGHEST_QUAL',
  p_display_order          =>7,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'G',
  p_column_label           =>'Highest Qual',
  p_report_label           =>'Highest Qual',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101426553203730+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_db_column_name         =>'PREFERRED_ROLE',
  p_display_order          =>8,
  p_group_id               =>null+wwv_flow_api.g_id_offset,
  p_column_identifier      =>'H',
  p_column_label           =>'Preferred Role',
  p_report_label           =>'Preferred Role',
  p_sync_form_label        =>'Y',
  p_display_in_default_rpt =>'Y',
  p_is_sortable            =>'Y',
  p_allow_sorting          =>'Y',
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101513527203730+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 5101611770203731+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
...
begin
rc1:=rc1||'CONTRACTOR_ID:CON_NAME:CON_POSTCODE:CON_SKILL_1:CON_SKILL_2:CON_SKILL_3:HIGHEST_QUAL:PREFERRED_ROLE:CREATEDBY:CREATEDDATE';

wwv_flow_api.create_worksheet_rpt(
  p_id => 5102908629218565+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
  p_worksheet_id => 5100604216203712+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5101900566203732 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 2,
...
wwv_flow_api.create_page_button(
  p_id             => 5101817381203731 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 2,
  p_button_sequence=> 30,
  p_button_plug_id => 5100429179203708+wwv_flow_api.g_id_offset,
  p_button_name    => 'CREATE',
  p_button_image   => 'template:'||to_char(5086323113181695+wwv_flow_api.g_id_offset),
...
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170122223603'
  );
null;
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5109022326300912 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Form on Stored Procedure',
  p_region_name=>'',
  p_plug_template=> 5087321151181698+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'AFTER_SHOW_ITEMS',
  p_plug_source=> s,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5111802264300918 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 4,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 5109309703300913 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
  p_button_sequence=> 20,
  p_button_plug_id => 5109022326300912+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 5109207532300913 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 4,
...
wwv_flow_api.create_page_branch(
  p_id=>5111508409300917 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_branch_action=> 'f?p=&APP_ID.:2:&SESSION.&success_msg=#SUCCESS_MSG#',
  p_branch_point=> 'AFTER_PROCESSING',
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>5109309703300913+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 1,
...
wwv_flow_api.create_page_item(
  p_id=>5109729554300914 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_NTRACTOR_ID',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5109022326300912+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Contractor Id',
  ...
  p_field_template=> 5091530618181705+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5109907075300914 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_N_NAME',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5110121880300915 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_N_POSTCODE',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5110314335300915 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_N_SKILL_1',
  p_data_type=> '',
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Con Skill 1',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select SKILL_DESC display_value, SKILL_ID return_value '||chr(10)||
'from LDS_SKILL'||chr(10)||
'order by 1',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5110514215300915 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_N_SKILL_2',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5110713400300916 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_N_SKILL_3',
  p_data_type=> '',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5110920389300916 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_GHEST_QUAL',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 70,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5111122697300916 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 4,
  p_name=>'P4_EFERRED_ROLE',
  p_data_type=> '',
  p_is_required=> true,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 80,
  ...
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_prompt=>'Preferred Role',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_SELECT_LIST',
  p_lov=> 'select JOB_ROLE_DESC display_value, JOB_ROLE_ID return_value '||chr(10)||
'from LDS_JOB_ROLE'||chr(10)||
'order by 1',
  p_lov_display_null=> 'NO',
  p_lov_translated=> 'N',
  p_cSize=> 30,
...
declare
  ...
  l_length number := 1;
begin
p:=p||'#OWNER#.INSERTUSER('||chr(10)||
'CONTRACTOR_ID => :P4_NTRACTOR_ID,'||chr(10)||
'CON_NAME => :P4_N_NAME,'||chr(10)||
'CON_POSTCODE => :P4_N_POSTCODE,'||chr(10)||
'CON_SKILL_1 => :P4_N_SKILL_1,'||chr(10)||
'CON_SKILL_2 => :P4_N_SKILL_2,'||chr(10)||
'CON_SKILL_3 => :P4_N_SKILL_3,'||chr(10)||
'HIGHEST_QUAL => :P4_GHEST_QUAL,'||chr(10)||
'PREFERRED_ROLE => :P4_EFERRED_ROLE);';

wwv_flow_api.create_page_process(
  p_id     => 5111329362300917 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 4,
  ...
  p_process_when_button_id=>5109309703300913 + wwv_flow_api.g_id_offset,
...
'No help is available for this page.'
 ,p_last_updated_by => 'CONTRACTORPROJECT'
 ,p_last_upd_yyyymmddhh24miss => '20170124221028'
  );
null;
...
declare
  ...
  l_length number := 1;
begin
s:=s||'select * from placeuser';

wwv_flow_api.create_report_region (
  p_id=> 5142010107024993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_name=> 'Users',
  p_region_name=>'',
  p_template=> 5088105898181699+ wwv_flow_api.g_id_offset,
  ...
  p_plug_caching=> 'NOT_CACHED',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 5090816442181704+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 5142321862025215 + wwv_flow_api.g_id_offset,
  p_region_id=> 5142010107024993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'PLACEUSERID',
  p_column_display_sequence=> 1,
  p_column_heading=> 'PLACEUSERID',
  p_column_alignment=>'LEFT',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5142422727025234 + wwv_flow_api.g_id_offset,
  p_region_id=> 5142010107024993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5142506158025234 + wwv_flow_api.g_id_offset,
  p_region_id=> 5142010107024993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 5142610135025234 + wwv_flow_api.g_id_offset,
  p_region_id=> 5142010107024993 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
  ...
  p_column_heading=> 'CONTRACTOR_ID',
  p_column_alignment=>'LEFT',
  p_default_sort_column_sequence=>0,
  p_disable_sort_column=>'N',
  p_sum_column=> 'N',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5142722306025258 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 5,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 5084802027181687 + wwv_flow_api.g_id_offset
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 5093427812181713 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>5093516757181714 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 5093427812181713+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5093610283181714 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>5093719947181714 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(5086323113181695 + wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_process(
  p_id     => 5093919527181715 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 5093805318181715 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5094114348181715 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
...
wwv_flow_api.create_page_process(
  p_id     => 5094007931181715 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 5094217492181715 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>5094708698181718 + wwv_flow_api.g_id_offset,
  p_menu_id=>5094217492181715 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
  p_option_sequence=>10,
  p_short_name=>'Admin Home',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5102304692203733 + wwv_flow_api.g_id_offset,
  p_menu_id=>5094217492181715 + wwv_flow_api.g_id_offset,
  p_parent_id=>5094708698181718 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Contractors',
  p_long_name=>'',
...
wwv_flow_api.create_menu_option (
  p_id=>5112106340300919 + wwv_flow_api.g_id_offset,
  p_menu_id=>5094217492181715 + wwv_flow_api.g_id_offset,
  p_parent_id=>5094708698181718 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Contractors',
...
wwv_flow_api.create_menu_option (
  p_id=>5143029977025280 + wwv_flow_api.g_id_offset,
  p_menu_id=>5094217492181715 + wwv_flow_api.g_id_offset,
  p_parent_id=>5094708698181718 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
  p_short_name=>'Users',
...
prompt  ......Page template 5084802027181687
...
wwv_flow_api.create_template(
  p_id=> 5084802027181687 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 5084930943181687
...
wwv_flow_api.create_template(
  p_id=> 5084930943181687 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085020387181691
...
wwv_flow_api.create_template(
  p_id=> 5085020387181691 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085124461181691
...
wwv_flow_api.create_template(
  p_id=> 5085124461181691 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085230100181691
...
wwv_flow_api.create_template(
  p_id=> 5085230100181691 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085307613181692
...
wwv_flow_api.create_template(
  p_id=> 5085307613181692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085431538181692
...
wwv_flow_api.create_template(
  p_id=> 5085431538181692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085505150181692
...
wwv_flow_api.create_template(
  p_id=> 5085505150181692 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085611845181693
...
wwv_flow_api.create_template(
  p_id=> 5085611845181693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085710192181693
...
wwv_flow_api.create_template(
  p_id=> 5085710192181693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 5085810250181693
...
wwv_flow_api.create_template(
  p_id=> 5085810250181693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5085916234181693
...
wwv_flow_api.create_template(
  p_id=> 5085916234181693 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5086014773181694
...
wwv_flow_api.create_template(
  p_id=> 5086014773181694 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5086122261181695
...
wwv_flow_api.create_template(
  p_id=> 5086122261181695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 5086201735181695
...
wwv_flow_api.create_template(
  p_id=> 5086201735181695 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 5086323113181695
declare
...
wwv_flow_api.create_button_templates (
  p_id=>5086323113181695 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5086412582181696
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5086412582181696 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5086516782181696
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5086516782181696 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 5086617425181697
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>5086617425181697 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 5086705589181697
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5086705589181697 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5086819000181697
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5086819000181697 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5086907173181697
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5086907173181697 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5087000156181698
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087000156181698 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5087131374181698
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087131374181698 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5087213069181698
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087213069181698 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5087321151181698
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087321151181698 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 5087420575181698
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087420575181698 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5087501999181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087501999181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5087631651181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087631651181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5087724963181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087724963181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5087807443181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087807443181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 5087924433181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5087924433181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 5088002158181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088002158181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5088105898181699
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088105898181699 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 5088202031181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088202031181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5088318877181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088318877181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5088418997181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088418997181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5088511337181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088511337181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5088609891181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088609891181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 5088707575181700
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088707575181700 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 5088814126181701
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 5088814126181701 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......list template 5088924540181701
...
wwv_flow_api.create_list_template (
  p_id=>5088924540181701 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 5089014227181701
...
wwv_flow_api.create_list_template (
  p_id=>5089014227181701 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089122761181701
...
wwv_flow_api.create_list_template (
  p_id=>5089122761181701 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089216733181701
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089216733181701 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089332501181701
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089332501181701 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089410581181702
...
wwv_flow_api.create_list_template (
  p_id=>5089410581181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089530030181702
...
wwv_flow_api.create_list_template (
  p_id=>5089530030181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089617962181702
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089617962181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089702214181702
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089702214181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089804461181702
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089804461181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5089917664181702
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5089917664181702 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5090013121181703
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5090013121181703 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5090122379181703
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5090122379181703 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5090228232181703
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5090228232181703 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 5090325604181703
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>5090325604181703 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 5090423727181703
...
wwv_flow_api.create_row_template (
  p_id=> 5090423727181703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5090531995181703
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5090531995181703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5090620598181703
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5090620598181703 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5090702452181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5090702452181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5090816442181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5090816442181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5090915441181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5090915441181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5091018220181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5091018220181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5091117869181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5091117869181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 5091212801181704
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 5091212801181704 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5091319957181705
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5091319957181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5091411258181705
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5091411258181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5091530618181705
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5091530618181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5091611861181705
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5091611861181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 5091723184181705
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 5091723184181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5091810696181705
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5091810696181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5091901760181705
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 5091901760181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 5092607031181707
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 5092607031181707 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5092019670181705
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5092019670181705 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5092206935181706
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5092206935181706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 5092404306181706
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 5092404306181706 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 5092725880181707
begin
wwv_flow_api.create_theme (
  p_id =>5092725880181707 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 1,
  ...
  p_login_template=>5084802027181687 + wwv_flow_api.g_id_offset,
  p_default_button_template=>5086323113181695 + wwv_flow_api.g_id_offset,
  p_default_region_template=>5088105898181699 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>5087213069181698 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>5087321151181698 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>5091530618181705 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>5091810696181705 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>5092019670181705 + wwv_flow_api.g_id_offset,
  p_default_list_template=>5090122379181703 + wwv_flow_api.g_id_offset,
  p_default_option_label=>5091530618181705 + wwv_flow_api.g_id_offset,
  p_default_required_label=>5091723184181705 + wwv_flow_api.g_id_offset);
end;
/
...
wwv_flow_api.create_shortcut (
 p_id=> 5096607717203684 + wwv_flow_api.g_id_offset,
 p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5092804826181711
...
wwv_flow_api.create_auth_setup (
  p_id=> 5092804826181711 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 5092930411181711
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5092930411181711 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 5093026691181711
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 5093026691181711 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
